...
import { MdClose, MdNavigation, MdAccessTime } from "react-icons/md";
...
function DeliveryOrderModal({ order, setSelectedOrder }) {
  ...
  const handleOpenInMaps = () => {
    if (hasCoordinates) {
      const url = `https://www.google.com/maps/dir/?api=1&destination=${order.deliveryAddress.coordinates.lat},${order.deliveryAddress.coordinates.lng}`;
          ...
          {hasCoordinates && (
            <div className="mb-4">
              ...
              {order.status === 'delivered' ? (
                ...
                // Delivered state - show success message and address
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                  ...
                  <div className="flex-1 flex flex-col gap-3">
                      ...
                      <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-medium text-yellow-800">
                            Accept the order to begin tracking...
                          </span>
                        </div>
                      </div>
                    )}
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2.5 bg-green-500 text-white text-sm font-semibold rounded-lg hover:bg-green-600 transition flex items-center justify-center gap-2 cursor-pointer"
                    >
